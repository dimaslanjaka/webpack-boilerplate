...
import flowbiteTheme from '@root/src/flowbite-theme';
...
export const WithBrowserRouter = (props: React.PropsWithChildren) => (
  <StrictMode>
...
export const WithoutBrowserRouter = (props: React.PropsWithChildren) => (
  <Flowbite theme={{ theme: flowbiteTheme }}>
    <FlowbiteContext>
      <SidebarProvider>
        <FlowbiteHeader />
        <div id="flowbite-main-content">
          <div className="flex flex-col md:flex-row dark:bg-gray-900">
            <div className="mx-4 mt-4 mb-24 flex-[1_0_16rem]" id="router-wrapper">
              {props.children ? props.children : <Outlet />}
            </div>
            {/* <div className="order-1">
              <ActualSidebar />
